...
namespace WowPacketParser.Enums.Version.V1_13_6_36231
{
    public static class Opcodes_1_13_6
    {
        ...
        private static readonly BiDictionary<Opcode, int> ClientOpcodes = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.CMSG_ACCEPT_LEVEL_GRANT, 0x34F9},
            ...
            {Opcode.CMSG_ADD_FRIEND, 0x36CD},
            {Opcode.CMSG_ADD_IGNORE, 0x36D1},
            {Opcode.CMSG_ADD_TOY, 0x3297},
            {Opcode.CMSG_ADDON_LIST, 0x35D8},
            {Opcode.CMSG_ADVENTURE_JOURNAL_OPEN_QUEST, 0x3204},
            ...
            {Opcode.CMSG_ASSIGN_EQUIPMENT_SET_SPEC, 0x320C},
            ...
            {Opcode.CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE, 0x36C8},
            {Opcode.CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE, 0x36C7},
            {Opcode.CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_TO_TARGET, 0x36BE},
            {Opcode.CMSG_BATTLE_PAY_GET_PRODUCT_LIST, 0x36B8},
            {Opcode.CMSG_BATTLE_PAY_GET_PURCHASE_LIST, 0x36B9},
            {Opcode.CMSG_BATTLE_PAY_OPEN_CHECKOUT, 0x370E},
            {Opcode.CMSG_BATTLE_PAY_QUERY_CLASS_TRIAL_BOOST_RESULT, 0x36C1},
            {Opcode.CMSG_BATTLE_PAY_REQUEST_CHARACTER_BOOST_UNREVOKE, 0x36BF},
            {Opcode.CMSG_VAS_GET_QUEUE_MINUTES, 0x370B},
            {Opcode.CMSG_BATTLE_PAY_REQUEST_PRICE_INFO, 0x370A},
            {Opcode.CMSG_BATTLE_PAY_START_PURCHASE, 0x36F0},
            {Opcode.CMSG_BATTLE_PAY_START_VAS_PURCHASE, 0x36F1},
            ...
            {Opcode.CMSG_BATTLE_PET_SET_BATTLE_SLOT, 0x362C},
            ...
            {Opcode.CMSG_BATTLEFIELD_PORT, 0x3526},
            {Opcode.CMSG_BATTLEMASTER_HELLO, 0x32AF},
            {Opcode.CMSG_BATTLEMASTER_JOIN, 0x3521},
            {Opcode.CMSG_BATTLEMASTER_JOIN_BRAWL, 0x3524},
            {Opcode.CMSG_BATTLEMASTER_JOIN_SKIRMISH, 0x3523},
            {Opcode.CMSG_BATTLENET_CHALLENGE_RESPONSE, 0x36D0},
            {Opcode.CMSG_BATTLENET_REQUEST, 0x36F4},
            ...
            {Opcode.CMSG_CALENDAR_COMMUNITY_FILTER, 0x366F},
            {Opcode.CMSG_CALENDAR_COMPLAIN, 0x3677},
            {Opcode.CMSG_CALENDAR_COPY_EVENT, 0x3676},
            {Opcode.CMSG_CALENDAR_EVENT_INVITE, 0x3670},
            {Opcode.CMSG_CALENDAR_EVENT_MODERATOR_STATUS, 0x3674},
            {Opcode.CMSG_CALENDAR_EVENT_RSVP, 0x3672},
            {Opcode.CMSG_CALENDAR_EVENT_SIGN_UP, 0x3679},
            {Opcode.CMSG_CALENDAR_EVENT_STATUS, 0x3673},
            ...
            {Opcode.CMSG_CAN_REDEEM_TOKEN_FOR_BALANCE, 0x3709},
            ...
            {Opcode.CMSG_CANCEL_MASTER_LOOT_ROLL, 0x3214},
            ...
            {Opcode.CMSG_CHAR_RACE_OR_FACTION_CHANGE, 0x3693},
            {Opcode.CMSG_CHARACTER_RENAME_REQUEST, 0x36BC},
            ...
            {Opcode.CMSG_CHECK_RAF_EMAIL_ENABLED, 0x36C9},
            ...
            {Opcode.CMSG_COMPLETE_CINEMATIC, 0x3546},
            {Opcode.CMSG_COMPLETE_MOVIE, 0x34DD},
            {Opcode.CMSG_CONFIRM_ARTIFACT_RESPEC, 0x31AD},
            {Opcode.CMSG_CONFIRM_RESPEC_WIPE, 0x320E},
            {Opcode.CMSG_CONNECT_TO_FAILED, 0x35D4},
            {Opcode.CMSG_CONTRIBUTION_CONTRIBUTE, 0x3557},
            {Opcode.CMSG_CONTRIBUTION_LAST_UPDATE_REQUEST, 0x3558},
            {Opcode.CMSG_CONVERSATION_LINE_STARTED, 0x3547},
            {Opcode.CMSG_CONVERT_RAID, 0x364D},
            {Opcode.CMSG_CREATE_CHARACTER, 0x3642},
            {Opcode.CMSG_DB_QUERY_BULK, 0x35E4},
            {Opcode.CMSG_DECLINE_GUILD_INVITES, 0x351F},
            {Opcode.CMSG_DECLINE_PETITION, 0x3535},
            {Opcode.CMSG_DEL_FRIEND, 0x36CE},
            {Opcode.CMSG_DEL_IGNORE, 0x36D2},
            {Opcode.CMSG_DELETE_EQUIPMENT_SET, 0x350C},
            {Opcode.CMSG_DESTROY_ITEM, 0x3291},
            {Opcode.CMSG_DISMISS_CRITTER, 0x34FB},
            {Opcode.CMSG_DO_MASTER_LOOT_ROLL, 0x3213},
            {Opcode.CMSG_DO_READY_CHECK, 0x3633},
            {Opcode.CMSG_DUEL_RESPONSE, 0x34E2},
            {Opcode.CMSG_EMOTE, 0x3542},
            ...
            {Opcode.CMSG_GET_ITEM_PURCHASE_DATA, 0x3530},
            ...
            {Opcode.CMSG_GRANT_LEVEL, 0x34F7},
            ...
            {Opcode.CMSG_GUILD_SET_GUILD_MASTER, 0x36C3},
            ...
            {Opcode.CMSG_HEARTH_AND_RESURRECT, 0x3508},
            {Opcode.CMSG_HOTFIX_REQUEST, 0x35E5},
            {Opcode.CMSG_IGNORE_TRADE, 0x3159},
            {Opcode.CMSG_INITIATE_TRADE, 0x3156},
            {Opcode.CMSG_INSPECT, 0x352A},
            {Opcode.CMSG_INSPECT_PVP, 0x317D},
            {Opcode.CMSG_INSTANCE_LOCK_RESPONSE, 0x350D},
            {Opcode.CMSG_ITEM_PURCHASE_REFUND, 0x3531},
            {Opcode.CMSG_ITEM_TEXT_QUERY, 0x331D},
            {Opcode.CMSG_JOIN_PET_BATTLE_QUEUE, 0x31DF},
            {Opcode.CMSG_JOIN_RATED_BATTLEGROUND, 0x317A},
            {Opcode.CMSG_KEEP_ALIVE, 0x367D},
            {Opcode.CMSG_KEYBOUND_OVERRIDE, 0x3223},
            {Opcode.CMSG_LEARN_TALENTS, 0x3553},
            {Opcode.CMSG_LEAVE_GROUP, 0x3648},
            {Opcode.CMSG_LEAVE_PET_BATTLE_QUEUE, 0x31E0},
            ...
            {Opcode.CMSG_LOW_LEVEL_RAID2, 0x3514},
            {Opcode.CMSG_MAIL_CREATE_TEXT_ITEM, 0x353C},
            {Opcode.CMSG_MAIL_DELETE, 0x3225},
            {Opcode.CMSG_MAIL_GET_LIST, 0x3537},
            {Opcode.CMSG_MAIL_MARK_AS_READ, 0x353B},
            {Opcode.CMSG_MAIL_RETURN_TO_SENDER, 0x3654},
            {Opcode.CMSG_MAIL_TAKE_ITEM, 0x3539},
            {Opcode.CMSG_MAIL_TAKE_MONEY, 0x3538},
            ...
            {Opcode.CMSG_PET_BATTLE_FINAL_NOTIFY, 0x31E4},
            {Opcode.CMSG_PET_BATTLE_INPUT, 0x363F},
            {Opcode.CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT, 0x3224},
            {Opcode.CMSG_PET_BATTLE_QUIT_NOTIFY, 0x31E3},
            {Opcode.CMSG_PET_BATTLE_REPLACE_FRONT_PET, 0x3640},
            {Opcode.CMSG_PET_BATTLE_REQUEST_PVP, 0x31DD},
            {Opcode.CMSG_PET_BATTLE_REQUEST_UPDATE, 0x31DE},
            {Opcode.CMSG_PET_BATTLE_REQUEST_WILD, 0x31DB},
            {Opcode.CMSG_PET_BATTLE_SCRIPT_ERROR_NOTIFY, 0x31E5},
            {Opcode.CMSG_PET_BATTLE_WILD_LOCATION_FAIL, 0x31DC},
            {Opcode.CMSG_PET_CANCEL_AURA, 0x348E},
            {Opcode.CMSG_PET_CAST_SPELL, 0x3299},
            {Opcode.CMSG_PET_RENAME, 0x3683},
            ...
            {Opcode.CMSG_QUERY_COMMUNITY_NAME, 0x3689},
            ...
            {Opcode.CMSG_QUERY_GUILD_INFO, 0x368C},
            {Opcode.CMSG_QUERY_NEXT_MAIL_TIME, 0x353A},
            ...
            {Opcode.CMSG_QUERY_PLAYER_NAME, 0x3688},
            {Opcode.CMSG_QUERY_QUEST_COMPLETION_NPCS, 0x3177},
            {Opcode.CMSG_QUERY_QUEST_INFO, 0x3273},
            {Opcode.CMSG_QUERY_REALM_NAME, 0x368B},
            {Opcode.CMSG_QUERY_TIME, 0x34D5},
            {Opcode.CMSG_QUERY_TREASURE_PICKER, 0x333C},
            ...
            {Opcode.CMSG_QUEST_LOG_REMOVE_QUEST, 0x352F},
            ...
            {Opcode.CMSG_RAID_OR_BATTLEGROUND_ENGINE_SURVEY, 0x36E2},
            ...
            {Opcode.CMSG_CONSUMABLE_TOKEN_REDEEM_CONFIRMATION, 0x36EC},
            {Opcode.CMSG_CONSUMABLE_TOKEN_REDEEM, 0x36EB},
            {Opcode.CMSG_REORDER_CHARACTERS, 0x35E9},
            {Opcode.CMSG_REPAIR_ITEM, 0x34EC},
            {Opcode.CMSG_REPLACE_TROPHY, 0x3301},
            {Opcode.CMSG_REPOP_REQUEST, 0x3527},
            ...
            {Opcode.CMSG_REPORT_SERVER_LAG, 0x337F},
            {Opcode.CMSG_REQUEST_ACCOUNT_DATA, 0x3694},
            {Opcode.CMSG_REQUEST_AREA_POI_UPDATE, 0x333D},
            ...
            {Opcode.CMSG_REQUEST_INSPECT_RATED_BG_STATS, 0x36A0},
            ...
            {Opcode.CMSG_REQUEST_RAID_INFO, 0x36C5},
            {Opcode.CMSG_REQUEST_RESEARCH_HISTORY, 0x3167},
            {Opcode.CMSG_REQUEST_STABLED_PETS, 0x3491},
            {Opcode.CMSG_REQUEST_VEHICLE_EXIT, 0x3236},
            {Opcode.CMSG_REQUEST_VEHICLE_NEXT_SEAT, 0x3238},
            {Opcode.CMSG_REQUEST_VEHICLE_PREV_SEAT, 0x3237},
            {Opcode.CMSG_REQUEST_VEHICLE_SWITCH_SEAT, 0x3239},
            {Opcode.CMSG_COMMERCE_TOKEN_GET_MARKET_PRICE, 0x36E4},
            {Opcode.CMSG_RESET_CHALLENGE_MODE, 0x3206},
            {Opcode.CMSG_RESET_CHALLENGE_MODE_CHEAT, 0x3207},
            {Opcode.CMSG_RESET_INSTANCES, 0x3666},
            {Opcode.CMSG_RESURRECT_RESPONSE, 0x3682},
            {Opcode.CMSG_REVERT_MONUMENT_APPEARANCE, 0x3303},
            {Opcode.CMSG_RIDE_VEHICLE_INTERACT, 0x323A},
            {Opcode.CMSG_SAVE_CUF_PROFILES, 0x318E},
            {Opcode.CMSG_SAVE_EQUIPMENT_SET, 0x350B},
            ...
            {Opcode.CMSG_SELF_RES, 0x3532},
            {Opcode.CMSG_SELL_ITEM, 0x34A2},
            {Opcode.CMSG_CONSUMABLE_TOKEN_BUY, 0x36E6},
            {Opcode.CMSG_CONSUMABLE_TOKEN_REDEEM, 0x36E5},
            {Opcode.CMSG_SEND_CONTACT_LIST, 0x36CC},
            {Opcode.CMSG_SEND_MAIL, 0x35FA},
            {Opcode.CMSG_SEND_SOR_REQUEST_VIA_ADDRESS, 0x3620},
            {Opcode.CMSG_SEND_TEXT_EMOTE, 0x3488},
            {Opcode.CMSG_SET_ACHIEVEMENTS_HIDDEN, 0x3226},
            {Opcode.CMSG_SET_ACTION_BAR_TOGGLES, 0x3533},
            {Opcode.CMSG_SET_ADVANCED_COMBAT_LOGGING, 0x32B3},
            {Opcode.CMSG_SET_ASSISTANT_LEADER, 0x364E},
            {Opcode.CMSG_SET_CONTACT_NOTES, 0x36CF},
            ...
            {Opcode.CMSG_SET_GAME_EVENT_DEBUG_VIEW_STATE, 0x31BC},
            {Opcode.CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT, 0x3322},
            ...
            {Opcode.CMSG_SET_PLAYER_DECLINED_NAMES, 0x3687},
            {Opcode.CMSG_SET_PREFERRED_CEMETERY, 0x3179},
            {Opcode.CMSG_SET_PVP, 0x32AA},
            {Opcode.CMSG_SET_ROLE, 0x35D9},
            {Opcode.CMSG_SET_SELECTION, 0x3529},
            ...
            {Opcode.CMSG_SET_USING_PARTY_GARRISON, 0x32E5},
            {Opcode.CMSG_SET_WAR_MODE, 0x32AB},
            {Opcode.CMSG_SET_WATCHED_FACTION, 0x34E1},
            {Opcode.CMSG_SIGN_PETITION, 0x3534},
            ...
            {Opcode.CMSG_START_CHALLENGE_MODE, 0x354B},
            ...
            {Opcode.CMSG_TOTEM_DESTROYED, 0x34FA},
            {Opcode.CMSG_TRADE_SKILL_SET_FAVORITE, 0x333B},
            {Opcode.CMSG_TRAINER_BUY_SPELL, 0x34AE},
            {Opcode.CMSG_TRAINER_LIST, 0x34AD},
            {Opcode.CMSG_TURN_IN_PETITION, 0x3536},
            {Opcode.CMSG_TUTORIAL_FLAG, 0x36DA},
            {Opcode.CMSG_TWITTER_CHECK_STATUS, 0x312A},
            {Opcode.CMSG_TWITTER_CONNECT, 0x3127},
            {Opcode.CMSG_TWITTER_DISCONNECT, 0x312B},
            {Opcode.CMSG_TWITTER_POST, 0x3323},
            {Opcode.CMSG_UI_TIME_REQUEST, 0x3699},
            ...
            {Opcode.CMSG_UPDATE_VAS_PURCHASE_STATES, 0x36F2},
            {Opcode.CMSG_AUCTIONABLE_TOKEN_SELL, 0x36ED},
            {Opcode.CMSG_COMMERCE_TOKEN_GET_COUNT, 0x36E3},
            {Opcode.CMSG_USE_CRITTER_ITEM, 0x323D},
            ...
            {Opcode.CMSG_VOICE_CHAT_JOIN_CHANNEL, 0x3711},
            {Opcode.CMSG_VOICE_CHAT_LOGIN, 0x3710},
        ...
        private static readonly BiDictionary<Opcode, int> ServerOpcodes = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.SMSG_ACHIEVEMENT_EARNED, 0x2661},
            {Opcode.SMSG_ACTIVATE_TAXI_REPLY, 0x26AB},
            {Opcode.SMSG_ACTIVE_GLYPHS, 0x2C53},
            {Opcode.SMSG_ADD_BATTLENET_FRIEND_RESPONSE, 0x265B},
            {Opcode.SMSG_ADD_ITEM_PASSIVE, 0x25BF},
            {Opcode.SMSG_ADD_LOSS_OF_CONTROL, 0x269A},
            {Opcode.SMSG_ADD_RUNE_POWER, 0x26EA},
            {Opcode.SMSG_ADDON_LIST_REQUEST, 0x2660},
            {Opcode.SMSG_ADJUST_SPLINE_DURATION, 0x25E8},
            {Opcode.SMSG_ADVENTURE_MAP_OPEN_NPC, 0x283A},
            {Opcode.SMSG_AE_LOOT_TARGET_ACK, 0x262E},
            {Opcode.SMSG_AE_LOOT_TARGETS, 0x262D},
            {Opcode.SMSG_AI_REACTION, 0x26E7},
            {Opcode.SMSG_ALL_ACCOUNT_CRITERIA, 0x2570},
            {Opcode.SMSG_ALL_ACHIEVEMENT_DATA, 0x256F},
            {Opcode.SMSG_ALL_GUILD_ACHIEVEMENTS, 0x29B8},
            {Opcode.SMSG_ALLIED_RACE_DETAILS, 0x283E},
            {Opcode.SMSG_ARCHAEOLOGY_SURVERY_CAST, 0x2586},
            {Opcode.SMSG_AREA_POI_UPDATE_RESPONSE, 0x284F},
            {Opcode.SMSG_AREA_SPIRIT_HEALER_TIME, 0x2789},
            {Opcode.SMSG_AREA_TRIGGER_DENIED, 0x26A1},
            {Opcode.SMSG_AREA_TRIGGER_FORCE_SET_POSITION_AND_FACING, 0x26A2},
            {Opcode.SMSG_AREA_TRIGGER_NO_CORPSE, 0x275D},
            {Opcode.SMSG_AREA_TRIGGER_PLAY_SPELL_VISUAL, 0x263E},
            {Opcode.SMSG_AREA_TRIGGER_RE_PATH, 0x263D},
            {Opcode.SMSG_AREA_TRIGGER_RE_SHAPE, 0x2641},
            {Opcode.SMSG_ARENA_CROWD_CONTROL_SPELL_RESULT, 0x264F},
            {Opcode.SMSG_ARENA_PREP_OPPONENT_SPECIALIZATIONS, 0x2666},
            {Opcode.SMSG_ARTIFACT_ENDGAME_POWERS_REFUNDED, 0x27F1},
            {Opcode.SMSG_ARTIFACT_FORGE_ERROR, 0x27EF},
            {Opcode.SMSG_ARTIFACT_RESPEC_PROMPT, 0x27F0},
            {Opcode.SMSG_ATTACK_START, 0x266E},
            {Opcode.SMSG_ATTACK_STOP, 0x266F},
            {Opcode.SMSG_ATTACK_SWING_ERROR, 0x273A},
            {Opcode.SMSG_ATTACK_SWING_LANDED_LOG, 0x273B},
            {Opcode.SMSG_ATTACKER_STATE_UPDATE, 0x27DA},
            ...
            {Opcode.SMSG_AZERITE_RESPEC_NPC, 0x283C},
            {Opcode.SMSG_BARBER_SHOP_RESULT, 0x26F0},
            {Opcode.SMSG_BATCH_PRESENCE_SUBSCRIPTION, 0x28A3},
            {Opcode.SMSG_BATTLE_NET_CONNECTION_STATUS, 0x284B},
            {Opcode.SMSG_BATTLE_PAY_ACK_FAILED, 0x27D1},
            {Opcode.SMSG_BATTLE_PAY_BATTLE_PET_DELIVERED, 0x27C5},
            {Opcode.SMSG_BATTLE_PAY_COLLECTION_ITEM_DELIVERED, 0x27C6},
            {Opcode.SMSG_BATTLE_PAY_CONFIRM_PURCHASE, 0x27D0},
            {Opcode.SMSG_BATTLE_PAY_DELIVERY_ENDED, 0x27C7},
            {Opcode.SMSG_BATTLE_PAY_DELIVERY_STARTED, 0x27C3},
            {Opcode.SMSG_BATTLE_PAY_DISTRIBUTION_UNREVOKED, 0x27C1},
            {Opcode.SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE, 0x27C2},
            {Opcode.SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE, 0x27C0},
            {Opcode.SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE, 0x27BE},
            {Opcode.SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE, 0x27BF},
            {Opcode.SMSG_BATTLE_PAY_MOUNT_DELIVERED, 0x27C4},
            {Opcode.SMSG_BATTLE_PAY_PURCHASE_UPDATE, 0x27CF},
            {Opcode.SMSG_BATTLE_PAY_START_CHECKOUT, 0x286C},
            {Opcode.SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE, 0x27CD},
            {Opcode.SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE, 0x27CC},
            {Opcode.SMSG_BATTLE_PAY_VALIDATE_PURCHASE_RESPONSE, 0x285D},
            {Opcode.SMSG_BATTLE_PET_CAGE_DATE_ERROR, 0x26A5},
            {Opcode.SMSG_BATTLE_PET_DELETED, 0x2606},
            {Opcode.SMSG_BATTLE_PET_ERROR, 0x2656},
            ...
            {Opcode.SMSG_BATTLEGROUND_INIT, 0x27A8},
            ...
            {Opcode.SMSG_BATTLEGROUND_POINTS, 0x27A7},
            {Opcode.SMSG_BATTLENET_CHALLENGE_ABORT, 0x27D9},
            {Opcode.SMSG_BATTLENET_CHALLENGE_START, 0x27D8},
            {Opcode.SMSG_BATTLENET_NOTIFICATION, 0x284A},
            {Opcode.SMSG_BATTLENET_RESPONSE, 0x2849},
            {Opcode.SMSG_BIND_POINT_UPDATE, 0x257C},
            {Opcode.SMSG_BINDER_CONFIRM, 0x2741},
            {Opcode.SMSG_BLACK_MARKET_BID_ON_ITEM_RESULT, 0x2645},
            {Opcode.SMSG_BLACK_MARKET_OPEN_RESULT, 0x2643},
            {Opcode.SMSG_BLACK_MARKET_OUTBID, 0x2646},
            {Opcode.SMSG_BLACK_MARKET_REQUEST_ITEMS_RESULT, 0x2644},
            {Opcode.SMSG_BLACK_MARKET_WON, 0x2647},
            {Opcode.SMSG_BONUS_ROLL_EMPTY, 0x2663},
            {Opcode.SMSG_BOSS_KILL, 0x27CB},
            {Opcode.SMSG_BREAK_TARGET, 0x266D},
            {Opcode.SMSG_BROADCAST_ACHIEVEMENT, 0x2BBC},
            {Opcode.SMSG_BUY_FAILED, 0x26F9},
            {Opcode.SMSG_BUY_SUCCEEDED, 0x26F8},
            {Opcode.SMSG_CACHE_INFO, 0x274B},
            {Opcode.SMSG_CACHE_VERSION, 0x274A},
            {Opcode.SMSG_CALENDAR_CLEAR_PENDING_ACTION, 0x26CB},
            {Opcode.SMSG_CALENDAR_COMMAND_RESULT, 0x26CC},
            {Opcode.SMSG_CALENDAR_COMMUNITY_INVITE, 0x26BB},
            {Opcode.SMSG_CALENDAR_EVENT_REMOVED_ALERT, 0x26C3},
            {Opcode.SMSG_CALENDAR_EVENT_UPDATED_ALERT, 0x26C4},
            {Opcode.SMSG_CALENDAR_INVITE_ADDED, 0x26BC},
            {Opcode.SMSG_CALENDAR_INVITE_ALERT, 0x26C0},
            {Opcode.SMSG_CALENDAR_INVITE_NOTES, 0x26C5},
            {Opcode.SMSG_CALENDAR_INVITE_NOTES_ALERT, 0x26C6},
            {Opcode.SMSG_CALENDAR_INVITE_REMOVED, 0x26BD},
            {Opcode.SMSG_CALENDAR_INVITE_REMOVED_ALERT, 0x26C2},
            {Opcode.SMSG_CALENDAR_INVITE_STATUS, 0x26BE},
            {Opcode.SMSG_CALENDAR_INVITE_STATUS_ALERT, 0x26C1},
            {Opcode.SMSG_CALENDAR_MODERATOR_STATUS, 0x26BF},
            {Opcode.SMSG_CALENDAR_RAID_LOCKOUT_ADDED, 0x26C7},
            {Opcode.SMSG_CALENDAR_RAID_LOCKOUT_REMOVED, 0x26C8},
            {Opcode.SMSG_CALENDAR_RAID_LOCKOUT_UPDATED, 0x26C9},
            {Opcode.SMSG_CALENDAR_SEND_CALENDAR, 0x26B9},
            {Opcode.SMSG_CALENDAR_SEND_EVENT, 0x26BA},
            {Opcode.SMSG_CALENDAR_SEND_NUM_PENDING, 0x26CA},
            {Opcode.SMSG_CAMERA_EFFECT, 0x276E},
            {Opcode.SMSG_CAN_DUEL_RESULT, 0x2678},
            {Opcode.SMSG_CAN_REDEEM_TOKEN_FOR_BALANCE_RESPONSE, 0x285C},
            {Opcode.SMSG_CANCEL_AUTO_REPEAT, 0x271B},
            {Opcode.SMSG_CANCEL_COMBAT, 0x2739},
            {Opcode.SMSG_CANCEL_ORPHAN_SPELL_VISUAL, 0x2C46},
            {Opcode.SMSG_CANCEL_SCENE, 0x2655},
            ...
            {Opcode.SMSG_CHANGE_PLAYER_DIFFICULTY_RESULT, 0x273C},
            {Opcode.SMSG_CHANGE_REALM_TICKET_RESPONSE, 0x284C},
            ...
            {Opcode.SMSG_CHAR_CUSTOMIZE_FAILURE, 0x2721},
            {Opcode.SMSG_CHAR_CUSTOMIZE_SUCCESS, 0x2722},
            {Opcode.SMSG_CHAR_FACTION_CHANGE_RESULT, 0x27F5},
            {Opcode.SMSG_CHARACTER_CHECK_UPGRADE_RESULT, 0x280B},
            {Opcode.SMSG_CHARACTER_LOGIN_FAILED, 0x274C},
            {Opcode.SMSG_CHARACTER_OBJECT_TEST_RESPONSE, 0x27D7},
            {Opcode.SMSG_CHARACTER_RENAME_RESULT, 0x27B0},
            {Opcode.SMSG_CHARACTER_UPGRADE_ABORTED, 0x280A},
            {Opcode.SMSG_CHARACTER_UPGRADE_COMPLETE, 0x2809},
            {Opcode.SMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_RESULT, 0x280C},
            {Opcode.SMSG_CHARACTER_UPGRADE_STARTED, 0x2808},
            ...
            {Opcode.SMSG_CHECK_WARGAME_ENTRY, 0x259A},
            {Opcode.SMSG_CLEAR_ALL_SPELL_CHARGES, 0x2C27},
            {Opcode.SMSG_CLEAR_BOSS_EMOTES, 0x25CD},
            {Opcode.SMSG_CLEAR_COOLDOWN, 0x26EC},
            {Opcode.SMSG_CLEAR_COOLDOWNS, 0x2C26},
            {Opcode.SMSG_CLEAR_LOSS_OF_CONTROL, 0x269C},
            {Opcode.SMSG_CLEAR_SPELL_CHARGES, 0x2C28},
            {Opcode.SMSG_CLEAR_TARGET, 0x26E3},
            {Opcode.SMSG_CLOSE_ARTIFACT_FORGE, 0x27EE},
            {Opcode.SMSG_COIN_REMOVED, 0x262C},
            {Opcode.SMSG_COMBAT_EVENT_FAILED, 0x2670},
            {Opcode.SMSG_COMMENTATOR_MAP_INFO, 0x274E},
            {Opcode.SMSG_COMMENTATOR_PLAYER_INFO, 0x273F},
            {Opcode.SMSG_COMMENTATOR_STATE_CHANGED, 0x274D},
            {Opcode.SMSG_COMPLAINT_RESULT, 0x26DA},
            {Opcode.SMSG_COMPLETE_SHIPMENT_RESPONSE, 0x27E9},
            {Opcode.SMSG_CONFIRM_PARTY_INVITE, 0x285B},
            {Opcode.SMSG_CONNECT_TO, 0x304D},
            {Opcode.SMSG_CONQUEST_FORMULA_CONSTANTS, 0x27D2},
            {Opcode.SMSG_CONSOLE_WRITE, 0x2652},
            {Opcode.SMSG_CONTACT_LIST, 0x27D5},
            {Opcode.SMSG_CONTRIBUTION_LAST_UPDATE_RESPONSE, 0x2865},
            {Opcode.SMSG_CONTROL_UPDATE, 0x2665},
            {Opcode.SMSG_COOLDOWN_CHEAT, 0x2782},
            {Opcode.SMSG_COOLDOWN_EVENT, 0x26EB},
            {Opcode.SMSG_CORPSE_LOCATION, 0x266C},
            {Opcode.SMSG_CORPSE_RECLAIM_DELAY, 0x2795},
            {Opcode.SMSG_CORPSE_TRANSPORT_QUERY, 0x2759},
            {Opcode.SMSG_CREATE_CHAR, 0x2746},
            {Opcode.SMSG_CREATE_SHIPMENT_RESPONSE, 0x27E8},
            {Opcode.SMSG_CRITERIA_DELETED, 0x2726},
            {Opcode.SMSG_CRITERIA_UPDATE, 0x2720},
            {Opcode.SMSG_CROSSED_INEBRIATION_THRESHOLD, 0x26F4},
            {Opcode.SMSG_CUSTOM_LOAD_SCREEN, 0x25E3},
            {Opcode.SMSG_DAILY_QUESTS_RESET, 0x2A80},
            {Opcode.SMSG_DAMAGE_CALC_LOG, 0x2813},
            {Opcode.SMSG_DB_REPLY, 0x25A0},
            {Opcode.SMSG_DEATH_RELEASE_LOC, 0x270E},
            {Opcode.SMSG_DEBUG_MENU_MANAGER_FULL_UPDATE, 0x267E},
            {Opcode.SMSG_DEFENSE_MESSAGE, 0x2BB6},
            {Opcode.SMSG_DELETE_CHAR, 0x2747},
            {Opcode.SMSG_DESTROY_ARENA_UNIT, 0x278B},
            {Opcode.SMSG_DIFFERENT_INSTANCE_FROM_PARTY, 0x258A},
            {Opcode.SMSG_DISCONNECT_REASON, 0x2834},
            ...
            {Opcode.SMSG_DISPLAY_PLAYER_CHOICE, 0x26A6},
            {Opcode.SMSG_DISPLAY_PROMOTION, 0x2669},
            {Opcode.SMSG_DISPLAY_QUEST_POPUP, 0x2A9C},
            {Opcode.SMSG_DISPLAY_TOAST, 0x2639},
            {Opcode.SMSG_DONT_AUTO_PUSH_SPELLS_TO_ACTION_BAR, 0x25F6},
            {Opcode.SMSG_DROP_NEW_CONNECTION, 0x304C},
            {Opcode.SMSG_DUEL_ARRANGED, 0x2672},
            {Opcode.SMSG_DUEL_COMPLETE, 0x2676},
            {Opcode.SMSG_DUEL_COUNTDOWN, 0x2675},
            {Opcode.SMSG_DUEL_IN_BOUNDS, 0x2674},
            {Opcode.SMSG_DUEL_OUT_OF_BOUNDS, 0x2673},
            {Opcode.SMSG_DUEL_REQUESTED, 0x2671},
            {Opcode.SMSG_DUEL_WINNER, 0x2677},
            {Opcode.SMSG_DURABILITY_DAMAGE_DEATH, 0x2791},
            {Opcode.SMSG_EMOTE, 0x2814},
            {Opcode.SMSG_ENABLE_BARBER_SHOP, 0x26EF},
            {Opcode.SMSG_ENCHANTMENT_LOG, 0x275A},
            {Opcode.SMSG_ENCOUNTER_END, 0x27CA},
            {Opcode.SMSG_ENCOUNTER_START, 0x27C9},
            {Opcode.SMSG_END_LIGHTNING_STORM, 0x26D6},
            {Opcode.SMSG_ENTER_ENCRYPTED_MODE, 0x3049},
            {Opcode.SMSG_ENUM_CHARACTERS_RESULT, 0x2582},
            {Opcode.SMSG_ENUM_VAS_PURCHASE_STATES_RESPONSE, 0x2839},
            {Opcode.SMSG_ENVIRONMENTAL_DAMAGE_LOG, 0x2C21},
            {Opcode.SMSG_EQUIPMENT_SET_ID, 0x26E4},
            {Opcode.SMSG_EXPECTED_SPAM_RECORDS, 0x2BB1},
            {Opcode.SMSG_EXPLORATION_EXPERIENCE, 0x27AD},
            {Opcode.SMSG_FACTION_BONUS_INFO, 0x276D},
            {Opcode.SMSG_FAILED_PLAYER_CONDITION, 0x25E2},
            {Opcode.SMSG_FAILED_QUEST_TURN_IN, 0x2858},
            {Opcode.SMSG_FEATURE_SYSTEM_STATUS, 0x25D1},
            {Opcode.SMSG_FEATURE_SYSTEM_STATUS_GLUE_SCREEN, 0x25D2},
            {Opcode.SMSG_FEIGN_DEATH_RESISTED, 0x278E},
            {Opcode.SMSG_FISH_ESCAPED, 0x2701},
            {Opcode.SMSG_FISH_NOT_HOOKED, 0x2700},
            {Opcode.SMSG_FLIGHT_SPLINE_SYNC, 0x2DF7},
            {Opcode.SMSG_FORCE_ANIM, 0x279C},
            {Opcode.SMSG_FORCE_OBJECT_RELINK, 0x2668},
            {Opcode.SMSG_FORCED_DEATH_UPDATE, 0x270F},
            {Opcode.SMSG_FRIEND_STATUS, 0x27D6},
            {Opcode.SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT, 0x25D6},
            {Opcode.SMSG_GAME_OBJECT_BASE, 0x2874},
            ...
            {Opcode.SMSG_GAME_OBJECT_RESET_STATE, 0x2764},
            {Opcode.SMSG_GAME_OBJECT_SET_STATE_LOCAL, 0x2848},
            {Opcode.SMSG_GAME_SPEED_SET, 0x26AF},
            {Opcode.SMSG_GAME_TIME_SET, 0x2753},
            {Opcode.SMSG_GAME_TIME_UPDATE, 0x2752},
            {Opcode.SMSG_GENERATE_RANDOM_CHARACTER_NAME_RESULT, 0x2583},
            {Opcode.SMSG_GENERATE_SSO_TOKEN_RESPONSE, 0x2866},
            {Opcode.SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT, 0x27AE},
            {Opcode.SMSG_GET_LANDING_PAGE_SHIPMENTS_RESPONSE, 0x27EB},
            {Opcode.SMSG_GET_SELECTED_TROPHY_ID_RESPONSE, 0x2810},
            {Opcode.SMSG_GET_SHIPMENT_INFO_RESPONSE, 0x27E6},
            {Opcode.SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE, 0x27EA},
            {Opcode.SMSG_GET_TROPHY_LIST_RESPONSE, 0x280F},
            {Opcode.SMSG_GET_VAS_ACCOUNT_CHARACTER_LIST_RESULT, 0x2835},
            {Opcode.SMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST_RESULT, 0x2836},
            {Opcode.SMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST_RESULT, 0x28A5},
            {Opcode.SMSG_GM_PLAYER_INFO, 0x2781},
            {Opcode.SMSG_GM_REQUEST_PLAYER_INFO, 0x25EE},
            {Opcode.SMSG_GM_TICKET_CASE_STATUS, 0x26D1},
            {Opcode.SMSG_GM_TICKET_SYSTEM_STATUS, 0x26D0},
            {Opcode.SMSG_GOD_MODE, 0x2740},
            {Opcode.SMSG_GOSSIP_COMPLETE, 0x2A96},
            {Opcode.SMSG_GOSSIP_MESSAGE, 0x2A97},
            {Opcode.SMSG_GOSSIP_POI, 0x27E3},
            {Opcode.SMSG_GOSSIP_QUEST_UPDATE, 0x2A98},
            {Opcode.SMSG_GROUP_ACTION_THROTTLED, 0x259C},
            {Opcode.SMSG_GROUP_AUTO_KICK, 0x27E1},
            {Opcode.SMSG_GROUP_DECLINE, 0x27DE},
            {Opcode.SMSG_GROUP_DESTROYED, 0x27E0},
            {Opcode.SMSG_GROUP_NEW_LEADER, 0x264A},
            {Opcode.SMSG_GROUP_UNINVITE, 0x27DF},
            ...
            {Opcode.SMSG_INIT_WORLD_STATES, 0x2792},
            {Opcode.SMSG_INITIAL_SETUP, 0x257F},
            {Opcode.SMSG_INITIALIZE_FACTIONS, 0x276C},
            {Opcode.SMSG_INSPECT_RESULT, 0x264E},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_CHANGE_PRIORITY, 0x27FB},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_DISENGAGE_UNIT, 0x27FA},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_END, 0x2803},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT, 0x27F9},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE, 0x2805},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION, 0x2804},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE, 0x27FE},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START, 0x27FD},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE, 0x2802},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED, 0x2806},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_START, 0x27FF},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_TIMER_START, 0x27FC},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_UPDATE_ALLOW_RELEASE_IN_PROGRESS, 0x2801},
            {Opcode.SMSG_INSTANCE_ENCOUNTER_UPDATE_SUPPRESS_RELEASE, 0x2800},
            {Opcode.SMSG_INSTANCE_GROUP_SIZE_CHANGED, 0x273D},
            {Opcode.SMSG_INSTANCE_INFO, 0x2651},
            {Opcode.SMSG_INSTANCE_RESET, 0x26B4},
            {Opcode.SMSG_INSTANCE_RESET_FAILED, 0x26B5},
            {Opcode.SMSG_INSTANCE_SAVE_CREATED, 0x27C8},
            {Opcode.SMSG_INTERRUPT_POWER_REGEN, 0x2C58},
            {Opcode.SMSG_INVALID_PROMOTION_CODE, 0x279D},
            {Opcode.SMSG_INVALIDATE_PAGE_TEXT, 0x270A},
            {Opcode.SMSG_INVALIDATE_PLAYER, 0x26D9},
            {Opcode.SMSG_INVENTORY_CHANGE_FAILURE, 0x276A},
            {Opcode.SMSG_INVENTORY_FIXUP_COMPLETE, 0x285A},
            {Opcode.SMSG_INVENTORY_FULL_OVERFLOW, 0x286E},
            {Opcode.SMSG_IS_QUEST_COMPLETE_RESPONSE, 0x2A83},
            {Opcode.SMSG_ISLAND_AZERITE_GAIN, 0x27AA},
            {Opcode.SMSG_ISLAND_COMPLETE, 0x27AB},
            {Opcode.SMSG_ISLANDS_MISSION_NPC, 0x283D},
            {Opcode.SMSG_ITEM_CHANGED, 0x2729},
            {Opcode.SMSG_ITEM_COOLDOWN, 0x2812},
            {Opcode.SMSG_ITEM_ENCHANT_TIME_UPDATE, 0x279F},
            ...
            {Opcode.SMSG_ITEM_TIME_UPDATE, 0x279E},
            ...
            {Opcode.SMSG_LEGACY_LOOT_RULES, 0x2875},
            ...
            {Opcode.SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT, 0x27BC},
            {Opcode.SMSG_LIVE_REGION_CHARACTER_COPY_RESULT, 0x27BA},
            {Opcode.SMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST_RESULT, 0x27AF},
            {Opcode.SMSG_LOAD_CUF_PROFILES, 0x25CE},
            {Opcode.SMSG_LOAD_EQUIPMENT_SET, 0x2755},
            {Opcode.SMSG_LOG_XP_GAIN, 0x2724},
            {Opcode.SMSG_LOGIN_SET_TIME_SPEED, 0x2754},
            {Opcode.SMSG_LOGIN_VERIFY_WORLD, 0x25AC},
            {Opcode.SMSG_LOGOUT_CANCEL_ACK, 0x26B3},
            {Opcode.SMSG_LOGOUT_COMPLETE, 0x26B2},
            {Opcode.SMSG_LOGOUT_RESPONSE, 0x26B1},
            {Opcode.SMSG_LOOT_ALL_PASSED, 0x2636},
            {Opcode.SMSG_LOOT_LIST, 0x278A},
            {Opcode.SMSG_LOOT_MONEY_NOTIFY, 0x2631},
            {Opcode.SMSG_LOOT_RELEASE, 0x2630},
            {Opcode.SMSG_LOOT_RELEASE_ALL, 0x262F},
            {Opcode.SMSG_LOOT_REMOVED, 0x262A},
            {Opcode.SMSG_LOOT_RESPONSE, 0x2629},
            {Opcode.SMSG_LOOT_ROLL, 0x2633},
            {Opcode.SMSG_LOOT_ROLL_WON, 0x2637},
            {Opcode.SMSG_LOOT_ROLLS_COMPLETE, 0x2635},
            {Opcode.SMSG_LOSS_OF_CONTROL_AURA_UPDATE, 0x2699},
            {Opcode.SMSG_MAIL_COMMAND_RESULT, 0x2659},
            {Opcode.SMSG_MAIL_LIST_RESULT, 0x27A0},
            {Opcode.SMSG_MAIL_QUERY_NEXT_TIME_RESULT, 0x27A1},
            {Opcode.SMSG_MAP_OBJ_EVENTS, 0x25D9},
            {Opcode.SMSG_MAP_OBJECTIVES_INIT, 0x27A9},
            {Opcode.SMSG_MASTER_LOOT_CANDIDATE_LIST, 0x2634},
            {Opcode.SMSG_MESSAGE_BOX, 0x2575},
            {Opcode.SMSG_MINIMAP_PING, 0x26FF},
            ...
            {Opcode.SMSG_MODIFY_COOLDOWN, 0x27B1},
            ...
            {Opcode.SMSG_MYTHIC_PLUS_CURRENT_AFFIXES, 0x2623},
            {Opcode.SMSG_MYTHIC_PLUS_NEW_SEASON_RECORD, 0x2626},
            ...
            {Opcode.SMSG_NEW_TAXI_PATH, 0x26AC},
            {Opcode.SMSG_NEW_WORLD, 0x25AB},
            {Opcode.SMSG_NOTIFY_DEST_LOC_SPELL_CAST, 0x2C43},
            {Opcode.SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION, 0x26D8},
            {Opcode.SMSG_NOTIFY_MONEY, 0x25AE},
            {Opcode.SMSG_NOTIFY_RECEIVED_MAIL, 0x265A},
            {Opcode.SMSG_OFFER_PETITION_ERROR, 0x26E8},
            {Opcode.SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA, 0x2725},
            {Opcode.SMSG_ON_MONSTER_MOVE, 0x2DA2},
            {Opcode.SMSG_OPEN_ARTIFACT_FORGE, 0x27ED},
            {Opcode.SMSG_OPEN_CONTAINER, 0x276B},
            {Opcode.SMSG_OPEN_LFG_DUNGEON_FINDER, 0x2A31},
            {Opcode.SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP, 0x27E5},
            {Opcode.SMSG_OPEN_SHIPMENT_NPC_RESULT, 0x27E7},
            {Opcode.SMSG_OVERRIDE_LIGHT, 0x26EE},
            {Opcode.SMSG_PAGE_TEXT, 0x2760},
            {Opcode.SMSG_PARTY_COMMAND_RESULT, 0x27E2},
            {Opcode.SMSG_PARTY_INVITE, 0x25CF},
            {Opcode.SMSG_PARTY_KILL_LOG, 0x27A5},
            {Opcode.SMSG_PARTY_MEMBER_FULL_STATE, 0x27A3},
            {Opcode.SMSG_PARTY_MEMBER_PARTIAL_STATE, 0x27A2},
            {Opcode.SMSG_PARTY_UPDATE, 0x260B},
            {Opcode.SMSG_PAUSE_MIRROR_TIMER, 0x2757},
            {Opcode.SMSG_PENDING_RAID_LOCK, 0x2738},
            {Opcode.SMSG_PET_ACTION_FEEDBACK, 0x2794},
            {Opcode.SMSG_PET_ACTION_SOUND, 0x26CE},
            {Opcode.SMSG_PET_ADDED, 0x25A8},
            {Opcode.SMSG_PET_BATTLE_CHAT_RESTRICTED, 0x2618},
            {Opcode.SMSG_PET_BATTLE_DEBUG_QUEUE_DUMP_RESPONSE, 0x26A0},
            ...
            {Opcode.SMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH, 0x2657},
            {Opcode.SMSG_PET_BATTLE_QUEUE_STATUS, 0x2658},
            ...
            {Opcode.SMSG_PET_DISMISS_SOUND, 0x26CF},
            {Opcode.SMSG_PET_GOD_MODE, 0x26A9},
            {Opcode.SMSG_PET_GUIDS, 0x2749},
            ...
            {Opcode.SMSG_PET_TAME_FAILURE, 0x26E5},
            ...
            {Opcode.SMSG_PETITION_SHOW_LIST, 0x26F1},
            {Opcode.SMSG_PETITION_SHOW_SIGNATURES, 0x26F2},
            {Opcode.SMSG_PETITION_SIGN_RESULTS, 0x2797},
            {Opcode.SMSG_PHASE_SHIFT_CHANGE, 0x2577},
            {Opcode.SMSG_PLAY_MUSIC, 0x27B6},
            {Opcode.SMSG_PLAY_OBJECT_SOUND, 0x27B7},
            {Opcode.SMSG_PLAY_ONE_SHOT_ANIM_KIT, 0x2779},
            {Opcode.SMSG_PLAY_ORPHAN_SPELL_VISUAL, 0x2C47},
            {Opcode.SMSG_PLAY_SCENE, 0x2654},
            {Opcode.SMSG_PLAY_SOUND, 0x27B5},
            {Opcode.SMSG_PLAY_SPEAKERBOT_SOUND, 0x27B8},
            {Opcode.SMSG_PLAY_SPELL_VISUAL, 0x2C45},
            {Opcode.SMSG_PLAY_SPELL_VISUAL_KIT, 0x2C49},
            {Opcode.SMSG_PLAY_TIME_WARNING, 0x2742},
            {Opcode.SMSG_PLAYED_TIME, 0x2711},
            {Opcode.SMSG_PLAYER_BOUND, 0x257D},
            {Opcode.SMSG_PLAYER_CONDITION_RESULT, 0x2843},
            {Opcode.SMSG_PLAYER_IS_ADVENTURE_MAP_POI_VALID, 0x2842},
            {Opcode.SMSG_PLAYER_SAVE_GUILD_EMBLEM, 0x29F6},
            {Opcode.SMSG_PLAYER_SKINNED, 0x278F},
            {Opcode.SMSG_PLAYER_TABARD_VENDOR_ACTIVATE, 0x27A4},
            {Opcode.SMSG_PLAYER_TUTORIAL_HIGHLIGHT_SPELL, 0x2847},
            {Opcode.SMSG_PLAYER_TUTORIAL_UNHIGHLIGHT_SPELL, 0x2846},
            {Opcode.SMSG_PONG, 0x304E},
            {Opcode.SMSG_POWER_UPDATE, 0x2705},
            {Opcode.SMSG_PRE_RESSURECT, 0x27B4},
            {Opcode.SMSG_PRINT_NOTIFICATION, 0x25E1},
            {Opcode.SMSG_PROC_RESIST, 0x27A6},
            ...
            {Opcode.SMSG_QUERY_PLAYER_NAME_BY_COMMUNITY_ID_RESPONSE, 0x2708},
            ...
            {Opcode.SMSG_RAF_EMAIL_ENABLED_RESPONSE, 0x27D3},
            {Opcode.SMSG_RAID_DIFFICULTY_SET, 0x27F6},
            {Opcode.SMSG_RAID_GROUP_ONLY, 0x27F8},
            {Opcode.SMSG_RAID_INSTANCE_MESSAGE, 0x2BB4},
            {Opcode.SMSG_RAID_MARKERS_CHANGED, 0x25B9},
            {Opcode.SMSG_RANDOM_ROLL, 0x264D},
            {Opcode.SMSG_RATED_BATTLEFIELD_INFO, 0x25A6},
            {Opcode.SMSG_READ_ITEM_RESULT_FAILED, 0x27F2},
            {Opcode.SMSG_READ_ITEM_RESULT_OK, 0x27EC},
            {Opcode.SMSG_READY_CHECK_COMPLETED, 0x260E},
            {Opcode.SMSG_READY_CHECK_RESPONSE, 0x260D},
            {Opcode.SMSG_READY_CHECK_STARTED, 0x260C},
            {Opcode.SMSG_REALM_LOOKUP_INFO, 0x2817},
            {Opcode.SMSG_REALM_QUERY_RESPONSE, 0x26ED},
            {Opcode.SMSG_REATTACH_RESURRECT, 0x2796},
            {Opcode.SMSG_RECRUIT_A_FRIEND_RESPONSE, 0x27D4},
            {Opcode.SMSG_REFER_A_FRIEND_FAILURE, 0x26F3},
            {Opcode.SMSG_REFRESH_COMPONENT, 0x267A},
            {Opcode.SMSG_REFRESH_SPELL_HISTORY, 0x2C2C},
            {Opcode.SMSG_REMOVE_ITEM_PASSIVE, 0x25C0},
            {Opcode.SMSG_REMOVE_LOSS_OF_CONTROL, 0x269B},
            {Opcode.SMSG_REPLACE_TROPHY_RESPONSE, 0x280E},
            {Opcode.SMSG_REPORT_PVP_PLAYER_AFK_RESULT, 0x26E1},
            ...
            {Opcode.SMSG_RESYNC_RUNES, 0x2745},
            ...
            {Opcode.SMSG_SCENARIO_COMPLETED, 0x2833},
            {Opcode.SMSG_SCENARIO_POIS, 0x2650},
            {Opcode.SMSG_SCENARIO_PROGRESS_UPDATE, 0x2649},
            {Opcode.SMSG_SCENARIO_SHOW_CRITERIA, 0x2841},
            {Opcode.SMSG_SCENARIO_STATE, 0x2648},
            {Opcode.SMSG_SCENARIO_UI_UPDATE, 0x2840},
            {Opcode.SMSG_SCENARIO_VACATE, 0x27F3},
            ...
            {Opcode.SMSG_SELL_RESPONSE, 0x26F7},
            {Opcode.SMSG_SEND_ITEM_PASSIVES, 0x25C1},
            {Opcode.SMSG_SEND_KNOWN_SPELLS, 0x2C2A},
            {Opcode.SMSG_SEND_RAID_TARGET_UPDATE_ALL, 0x264B},
            {Opcode.SMSG_SEND_RAID_TARGET_UPDATE_SINGLE, 0x264C},
            {Opcode.SMSG_SEND_SPELL_CHARGES, 0x2C2D},
            {Opcode.SMSG_SEND_SPELL_HISTORY, 0x2C2B},
            {Opcode.SMSG_SEND_UNLEARN_SPELLS, 0x2C2E},
            {Opcode.SMSG_SERVER_FIRST_ACHIEVEMENTS, 0x266B},
            {Opcode.SMSG_SERVER_TIME, 0x26B0},
            {Opcode.SMSG_SERVER_TIME_OFFSET, 0x275B},
            {Opcode.SMSG_SET_AI_ANIM_KIT, 0x2778},
            {Opcode.SMSG_SET_ALL_TASK_PROGRESS, 0x27DC},
            {Opcode.SMSG_SET_ANIM_TIER, 0x277C},
            {Opcode.SMSG_SET_CHR_UPGRADE_TIER, 0x25F5},
            {Opcode.SMSG_SET_CURRENCY, 0x2573},
            {Opcode.SMSG_SET_DF_FAST_LAUNCH_RESULT, 0x2A2E},
            {Opcode.SMSG_SET_FACTION_AT_WAR, 0x2744},
            {Opcode.SMSG_SET_FACTION_NOT_VISIBLE, 0x2773},
            {Opcode.SMSG_SET_FACTION_STANDING, 0x2774},
            {Opcode.SMSG_SET_FACTION_VISIBLE, 0x2772},
            {Opcode.SMSG_SET_FLAT_SPELL_MODIFIER, 0x2C36},
            {Opcode.SMSG_SET_FORCED_REACTIONS, 0x2763},
            {Opcode.SMSG_SET_ITEM_PURCHASE_DATA, 0x25B0},
            {Opcode.SMSG_SET_LOOT_METHOD_FAILED, 0x281D},
            {Opcode.SMSG_SET_MAX_WEEKLY_QUANTITY, 0x25B7},
            {Opcode.SMSG_SET_MELEE_ANIM_KIT, 0x277B},
            {Opcode.SMSG_SET_MOVEMENT_ANIM_KIT, 0x277A},
            {Opcode.SMSG_SET_PCT_SPELL_MODIFIER, 0x2C37},
            {Opcode.SMSG_SET_PET_SPECIALIZATION, 0x2642},
            {Opcode.SMSG_SET_PLAY_HOVER_ANIM, 0x25CC},
            {Opcode.SMSG_SET_PLAYER_DECLINED_NAMES_RESULT, 0x2710},
            {Opcode.SMSG_SET_PROFICIENCY, 0x277D},
            {Opcode.SMSG_SET_SPELL_CHARGES, 0x2C29},
            {Opcode.SMSG_SET_TASK_COMPLETE, 0x27DD},
            {Opcode.SMSG_SET_TIME_ZONE_INFORMATION, 0x26A4},
            {Opcode.SMSG_SET_VEHICLE_REC_ID, 0x2737},
            {Opcode.SMSG_SETUP_CURRENCY, 0x2572},
            {Opcode.SMSG_SETUP_RESEARCH_HISTORY, 0x2584},
            {Opcode.SMSG_SHOW_BANK, 0x26AD},
            {Opcode.SMSG_SHOW_MAILBOX, 0x27F4},
            {Opcode.SMSG_SHOW_NEUTRAL_PLAYER_FACTION_SELECT_UI, 0x25F1},
            {Opcode.SMSG_SHOW_TAXI_NODES, 0x26FE},
            {Opcode.SMSG_SHOW_TRADE_SKILL_RESPONSE, 0x27BD},
            {Opcode.SMSG_SOCKET_GEMS_FAILURE, 0x2770},
            {Opcode.SMSG_SOCKET_GEMS_SUCCESS, 0x276F},
            {Opcode.SMSG_SOR_START_EXPERIENCE_INCOMPLETE, 0x25F3},
            {Opcode.SMSG_SPEC_INVOLUNTARILY_CHANGED, 0x275F},
            {Opcode.SMSG_SPECIAL_MOUNT_ANIM, 0x26CD},
            ...
            {Opcode.SMSG_SPIRIT_HEALER_CONFIRM, 0x275C},
            {Opcode.SMSG_STAND_STATE_UPDATE, 0x2762},
            {Opcode.SMSG_START_ELAPSED_TIMER, 0x261A},
            {Opcode.SMSG_START_ELAPSED_TIMERS, 0x261C},
            {Opcode.SMSG_START_LIGHTNING_STORM, 0x26D5},
            {Opcode.SMSG_START_LOOT_ROLL, 0x2632},
            {Opcode.SMSG_START_MIRROR_TIMER, 0x2756},
            {Opcode.SMSG_START_TIMER, 0x25BB},
            {Opcode.SMSG_STOP_ELAPSED_TIMER, 0x261B},
            {Opcode.SMSG_STOP_MIRROR_TIMER, 0x2758},
            {Opcode.SMSG_STOP_SPEAKERBOT_SOUND, 0x27B9},
            {Opcode.SMSG_STREAMING_MOVIES, 0x25BA},
            {Opcode.SMSG_SUMMON_CANCEL, 0x26E0},
            {Opcode.SMSG_SUMMON_RAID_MEMBER_VALIDATE_FAILED, 0x258E},
            {Opcode.SMSG_SUMMON_REQUEST, 0x2767},
            {Opcode.SMSG_SUPERCEDED_SPELLS, 0x2C4C},
            {Opcode.SMSG_SUSPEND_COMMS, 0x304A},
            {Opcode.SMSG_SUSPEND_TOKEN, 0x25BD},
            {Opcode.SMSG_TALENTS_INVOLUNTARILY_RESET, 0x275E},
            {Opcode.SMSG_TAXI_NODE_STATUS, 0x26AA},
            {Opcode.SMSG_TEXT_EMOTE, 0x26A8},
            {Opcode.SMSG_THREAT_CLEAR, 0x2718},
            {Opcode.SMSG_THREAT_REMOVE, 0x2717},
            {Opcode.SMSG_THREAT_UPDATE, 0x2716},
            {Opcode.SMSG_TIME_ADJUSTMENT, 0x2DA1},
            {Opcode.SMSG_TIME_SYNC_REQUEST, 0x2DA0},
            {Opcode.SMSG_TITLE_EARNED, 0x2713},
            {Opcode.SMSG_TITLE_LOST, 0x2714},
            {Opcode.SMSG_TOTEM_CREATED, 0x26FA},
            {Opcode.SMSG_TOTEM_MOVED, 0x26FB},
            {Opcode.SMSG_TRADE_STATUS, 0x2581},
            {Opcode.SMSG_TRADE_UPDATED, 0x2580},
            {Opcode.SMSG_TRAINER_BUY_FAILED, 0x271D},
            {Opcode.SMSG_TRAINER_LIST, 0x271E},
            {Opcode.SMSG_TRANSFER_ABORTED, 0x2748},
            {Opcode.SMSG_TRANSFER_PENDING, 0x25E5},
            {Opcode.SMSG_TRANSMOGRIFY_NPC, 0x283B},
            {Opcode.SMSG_TREASURE_PICKER_RESPONSE, 0x284D},
            {Opcode.SMSG_TRIGGER_CINEMATIC, 0x2815},
            {Opcode.SMSG_TRIGGER_MOVIE, 0x26FC},
            {Opcode.SMSG_TURN_IN_PETITION_RESULT, 0x2799},
            {Opcode.SMSG_TUTORIAL_FLAGS, 0x2807},
            {Opcode.SMSG_TWITTER_STATUS, 0x2FFD},
            {Opcode.SMSG_UI_HEALING_RANGE_MODIFIED, 0x278D},
            {Opcode.SMSG_UNDELETE_CHARACTER_RESPONSE, 0x2818},
            {Opcode.SMSG_UNDELETE_COOLDOWN_STATUS_RESPONSE, 0x2819},
            {Opcode.SMSG_UNLEARNED_SPELLS, 0x2C4E},
            {Opcode.SMSG_UPDATE_ACCOUNT_DATA, 0x2750},
            {Opcode.SMSG_UPDATE_BNET_SESSION_KEY, 0x286D},
            {Opcode.SMSG_UPDATE_CELESTIAL_BODY, 0x2869},
            {Opcode.SMSG_UPDATE_CHARACTER_FLAGS, 0x280D},
            {Opcode.SMSG_UPDATE_CHARGE_CATEGORY_COOLDOWN, 0x27B3},
            {Opcode.SMSG_UPDATE_COOLDOWN, 0x27B2},
            {Opcode.SMSG_UPDATE_EXPANSION_LEVEL, 0x2664},
            {Opcode.SMSG_UPDATE_GAME_TIME_STATE, 0x2870},
            {Opcode.SMSG_UPDATE_INSTANCE_OWNERSHIP, 0x26D7},
            {Opcode.SMSG_UPDATE_LAST_INSTANCE, 0x26B6},
            {Opcode.SMSG_UPDATE_OBJECT, 0x2816},
            {Opcode.SMSG_UPDATE_PRIMARY_SPEC, 0x25ED},
            {Opcode.SMSG_UPDATE_TALENT_DATA, 0x25EC},
            {Opcode.SMSG_UPDATE_TASK_PROGRESS, 0x27DB},
            {Opcode.SMSG_UPDATE_WEEKLY_SPELL_USAGE, 0x2C19},
            {Opcode.SMSG_UPDATE_WORLD_STATE, 0x2793},
            {Opcode.SMSG_USE_EQUIPMENT_SET_RESULT, 0x279A},
            {Opcode.SMSG_USERLIST_ADD, 0x2BB9},
            {Opcode.SMSG_USERLIST_REMOVE, 0x2BBA},
            {Opcode.SMSG_USERLIST_UPDATE, 0x2BBB},
            {Opcode.SMSG_VAS_CHECK_TRANSFER_OK_RESPONSE, 0x2864},
            {Opcode.SMSG_VAS_GET_QUEUE_MINUTES_RESPONSE, 0x285F},
            {Opcode.SMSG_VAS_GET_SERVICE_STATUS_RESPONSE, 0x285E},
            {Opcode.SMSG_VAS_PURCHASE_COMPLETE, 0x2838},
            {Opcode.SMSG_VAS_PURCHASE_STATE_UPDATE, 0x2837},
            {Opcode.SMSG_VENDOR_INVENTORY, 0x25CA},
            {Opcode.SMSG_VIGNETTE_UPDATE, 0x27BB},
            ...
            {Opcode.SMSG_WARDEN3_DISABLED, 0x286B},
            {Opcode.SMSG_WARDEN3_ENABLED, 0x286A},
            {Opcode.SMSG_WARFRONT_COMPLETE, 0x27AC},
            {Opcode.SMSG_WARGAME_REQUEST_SENT, 0x259E},
            {Opcode.SMSG_WARGAME_REQUEST_SUCCESSFULLY_SENT_TO_OPPONENT, 0x25B4},
            {Opcode.SMSG_WEATHER, 0x26D4},
            {Opcode.SMSG_WEEKLY_SPELL_USAGE, 0x2C18},
            {Opcode.SMSG_WHO, 0x2BAE},
            {Opcode.SMSG_WHO_IS, 0x26D3},
            {Opcode.SMSG_WILL_BE_KICKED_FOR_ADDED_SUBSCRIPTION_TIME, 0x286F},
            {Opcode.SMSG_WORLD_MAP_OPEN_NPC, 0x2859},
            {Opcode.SMSG_WORLD_QUEST_UPDATE_RESPONSE, 0x284E},
            {Opcode.SMSG_WORLD_SERVER_INFO, 0x25C2},
            {Opcode.SMSG_XP_GAIN_ABORTED, 0x25E0},
            {Opcode.SMSG_XP_GAIN_ENABLED, 0x27F7},
